...
public class Practice05ComposeShaderView extends View {
    ...
    Bitmap mBitmap1 = BitmapFactory.decodeResource(getResources(), R.drawable.batman);
    Bitmap mBitmap2 = BitmapFactory.decodeResource(getResources(), R.drawable.batman_logo);
    Shader mShader1 = new BitmapShader(mBitmap1, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
    Shader mShader2 = new BitmapShader(mBitmap2, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
    Shader mShader = new ComposeShader(mShader1, mShader2, PorterDuff.Mode.DST_IN);
