...
public class Practice12PathEffectView extends View {
...

    {
        ...
        trianglePath.moveTo(40,40);
        trianglePath.rLineTo(30,40);
        trianglePath.rLineTo(-60,0);
        trianglePath.close();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        PathEffect pathEffect = new PathDashPathEffect(trianglePath, 40,0, PathDashPathEffect.Style.TRANSLATE);
